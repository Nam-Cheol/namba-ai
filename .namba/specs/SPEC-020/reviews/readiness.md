...
- Product Review
  ...
  Artifact: `.namba/specs/SPEC-020/reviews/product.md`
- Engineering Review
  Status: approved
  Last Reviewed: 2026-04-01
  Reviewer: Codex
  Skill: `$namba-plan-eng-review`
  Artifact: `.namba/specs/SPEC-020/reviews/engineering.md`
- Design Review
  Status: pending
  Last Reviewed: pending
  Reviewer: pending
  Skill: `$namba-plan-design-review`
  Artifact: `.namba/specs/SPEC-020/reviews/design.md`

## Summary

- Cleared reviews: 2/3
- Advisory status: follow up on design=pending before execution or GitHub handoff if the risk profile justifies it.
