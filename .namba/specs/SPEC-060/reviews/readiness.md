...
- Product Review
  ...
  Artifact: `.namba/specs/SPEC-060/reviews/product.md`
- Engineering Review
  Status: approved
  Last Reviewed: 2026-05-21
  Reviewer: namba-planner
  Skill: `$namba-plan-eng-review`
  Artifact: `.namba/specs/SPEC-060/reviews/engineering.md`
- Design Review
  Status: clear
  Last Reviewed: 2026-05-21
  Reviewer: namba-designer
  Skill: `$namba-plan-design-review`
  Artifact: `.namba/specs/SPEC-060/reviews/design.md`

## Frontend Gate

- Classification source: `.namba/specs/SPEC-060/frontend-brief.md`
...
- Runtime contract anchor: `.namba/specs/SPEC-060/contract.md`
- Baseline evidence: `.namba/specs/SPEC-060/baseline.md`
- Harness request: `.namba/specs/SPEC-060/harness-request.json`
- Eval plan: `.namba/specs/SPEC-060/eval-plan.md`
