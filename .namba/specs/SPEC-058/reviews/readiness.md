...
- Product Review
  ...
  Artifact: `.namba/specs/SPEC-058/reviews/product.md`
- Engineering Review
  Status: clear
  Last Reviewed: 2026-05-21
  Reviewer: namba-planner
  Skill: `$namba-plan-eng-review`
  Artifact: `.namba/specs/SPEC-058/reviews/engineering.md`
- Design Review
  Status: clear
  Last Reviewed: 2026-05-21
  Reviewer: namba-designer
  Skill: `$namba-plan-design-review`
  Artifact: `.namba/specs/SPEC-058/reviews/design.md`
...
- Runtime contract anchor: `.namba/specs/SPEC-058/contract.md`
- Baseline evidence: `.namba/specs/SPEC-058/baseline.md`
- Harness request: `.namba/specs/SPEC-058/harness-request.json`
- Eval plan: `.namba/specs/SPEC-058/eval-plan.md`
