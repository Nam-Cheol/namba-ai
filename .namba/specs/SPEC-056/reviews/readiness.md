...
- Product Review
  ...
  Artifact: `.namba/specs/SPEC-056/reviews/product.md`
- Engineering Review
  Status: clear
  Last Reviewed: 2026-05-20
  Reviewer: Codex local review
  Skill: `$namba-plan-eng-review`
  Artifact: `.namba/specs/SPEC-056/reviews/engineering.md`
- Design Review
  Status: clear
  Last Reviewed: 2026-05-20
  Reviewer: Codex local review
  Skill: `$namba-plan-design-review`
  Artifact: `.namba/specs/SPEC-056/reviews/design.md`
...
- Runtime contract anchor: `.namba/specs/SPEC-056/contract.md`
- Baseline evidence: `.namba/specs/SPEC-056/baseline.md`
- Harness request: `.namba/specs/SPEC-056/harness-request.json`
- Eval plan: `.namba/specs/SPEC-056/eval-plan.md`
- Harness map: `.namba/specs/SPEC-056/harness-map.md`
