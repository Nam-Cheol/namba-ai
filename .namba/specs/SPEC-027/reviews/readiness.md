...
- Product Review
  ...
  Artifact: `.namba/specs/SPEC-027/reviews/product.md`
- Engineering Review
  Status: clear
  Last Reviewed: 2026-04-10
  Reviewer: namba-planner
  Skill: `$namba-plan-eng-review`
  Artifact: `.namba/specs/SPEC-027/reviews/engineering.md`
- Design Review
  Status: clear
  Last Reviewed: 2026-04-10
  Reviewer: namba-designer
  Skill: `$namba-plan-design-review`
  Artifact: `.namba/specs/SPEC-027/reviews/design.md`
...
- Runtime contract anchor: `.namba/specs/SPEC-027/contract.md`
- Baseline evidence: `.namba/specs/SPEC-027/baseline.md`
- Extraction map: `.namba/specs/SPEC-027/extraction-map.md`
