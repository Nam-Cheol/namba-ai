...
- [ ] Regression tests cover planning, `frontend-minor` persistence, UI keyword boundary classification, malformed-header parsing, pending design-review blocking, cross-artifact mismatch handling, blocked-run remediation guidance, design judgment scaffolds, rule-enforcement examples, and backwards compatibility.
