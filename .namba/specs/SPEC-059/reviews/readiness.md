...
- Product Review
  ...
  Artifact: `.namba/specs/SPEC-059/reviews/product.md`
- Engineering Review
  Status: clear
  Last Reviewed: 2026-05-21
  Reviewer: Codex local engineering review
  Skill: `$namba-plan-eng-review`
  Artifact: `.namba/specs/SPEC-059/reviews/engineering.md`
- Design Review
  Status: clear
  Last Reviewed: 2026-05-21
  Reviewer: Codex local design review
  Skill: `$namba-plan-design-review`
  Artifact: `.namba/specs/SPEC-059/reviews/design.md`
...
- Runtime contract anchor: `.namba/specs/SPEC-059/contract.md`
- Baseline evidence: `.namba/specs/SPEC-059/baseline.md`
- Harness request: `.namba/specs/SPEC-059/harness-request.json`
- Eval plan: `.namba/specs/SPEC-059/eval-plan.md`
