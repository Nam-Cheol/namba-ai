...
- Primary landing doc for `namba-ai`.
- Output template: `foundation-v1`.
- Source priority: code > config > test > build > docs > planning > generated.
...
- Mismatch report: `.namba/project/mismatch-report.md` (0 conflicts).
- Quality report: `.namba/project/quality-report.md` (1 warnings, 0 errors).
