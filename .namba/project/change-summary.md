...
- Collaboration docs require one branch per SPEC/task from `main`, PRs into `main`, korean PR content, and explicit Codex review requests via `namba pr --review` or queue `--review` using `@codex review`.
...
- Latest readiness artifact: `.namba/specs/SPEC-047/reviews/readiness.md`
- Advisory summary: product=approved after revision, engineering=approved after revision, design=approved / not applicable
