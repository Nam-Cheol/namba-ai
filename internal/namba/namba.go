	...
	return []delegationDomainConfig{
		{
			...
			PlanningKeywords: []string{"component/state", "plan the component", "plan the state", "split", "component boundary", "component boundaries", "state ownership", "ownership", "file planning"},
		},
