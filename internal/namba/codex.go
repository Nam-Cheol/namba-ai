...
func codexScaffoldFiles(profile initProfile) map[string]string {
	files := map[string]string{
		...
		filepath.ToSlash(filepath.Join(repoCodexAgentsDir, "namba-planner.toml")):     renderPlannerAgent(),
		filepath.ToSlash(filepath.Join(repoCodexAgentsDir, "namba-implementer.toml")): renderImplementerAgent(),
		filepath.ToSlash(filepath.Join(repoCodexAgentsDir, "namba-reviewer.toml")):    renderReviewerAgent(),
	}
