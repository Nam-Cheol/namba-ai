...
func renderNambaCLIRoot(lang string, cfg docsConfig) string {
	...
	default:
		lines := []string{
			...
			"| Plan harness work | `namba harness` / `namba harness \"description\"` | [Workflow Guide](docs/workflow-guide.md) |",
			"| Repair a bug | `namba fix`, `namba fix \"issue\"`, `namba fix --command plan`, or `namba fix --command plan \"issue\"` | [Workflow Guide](docs/workflow-guide.md) |",
