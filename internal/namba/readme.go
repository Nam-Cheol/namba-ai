...
func renderNambaCLIRoot(lang string, cfg docsConfig) string {
	...
	default:
		return strings.Join([]string{
			...
			fmt.Sprintf("- [%s](%s): update vs regen vs sync, generated assets, and collaboration defaults", localizeGuideLabel(lang, "workflow-guide"), guidePath("workflow-guide", lang)),
...
func renderManagedProjectRoot(lang string, projectCfg projectConfig, profile initProfile, cfg docsConfig) string {
	...
	default:
		return strings.Join([]string{
			...
			"- Execute `namba run SPEC-XXX`, validate changes, and finish with `namba sync`.",
