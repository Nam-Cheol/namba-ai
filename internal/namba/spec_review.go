	...
	return []specReviewTemplate{
		...
		},
		{
			...
			Checklist: []string{
				...
				"The Do-Not Design Contract is complete enough to block generic fallback, including default-library fit, context-specific bans, allowed replacements, brand/category/trust reasoning, visual grammar, architecture handoff, and violation-check plan.",
